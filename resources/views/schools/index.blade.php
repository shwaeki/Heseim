                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="input-style-1">
                            ...
                            <input type="text" id="code_update" name="code" placeholder="Code">
                        </div>
                        <div class="input-style-1">
                            <label for="he_name">Hebrew Name</label>
...
@push('scripts')
    ...
    <script>
        function editSchool(btn, id) {
            var myModal = new bootstrap.Modal(document.getElementById("UpdateModal"), {});
            myModal.show();

            var newAction = "{{route('schools.update',-1)}}".replace("-1", id);
            var action = $('#UpdateModal form').attr('action',newAction);
            $('#code_update').val($(btn).data('code'));
